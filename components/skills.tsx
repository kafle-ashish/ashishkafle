      ...
      <div className={styles.skills__second}>
        ...
        <div className={styles.tools__container}>
          <img
            ...
            width="122"
            height="75"
            className={styles.tools__images}
            style={{
              backgroundColor: "#333",
              padding: "10px",
              borderRadius: "3px",
          ...
          ></img>
          <Mongodb className={styles.tools__images} height="75" width="130" />
          {/* <img src={Mongodb} height="75" className={styles.tools__images}></img> */}
        </div>
        <div className={styles.tools__container}>
          <img
        ...
        <div className={styles.tools__container}>
          ...
          <img
            ...
            className={styles.tools__images}
          ></img>
          <Github className={styles.tools__images} height="75" width="130" />
          <img
...
const Mongodb = (props: any) =>
  <svg className={props.className + " h-25"} height={props.height ?? "25"} width={props.width} viewBox="0 0 100 25">
    <g>
      <path d="M11.71 10.41C10.31 4.33 7.39 2.71 6.65 1.57 6.34 1.06 6.07 0.54 5.84 0 5.8 0.54 5.73 0.88 5.26 1.29 4.32 2.11 0.35 5.3 0.01 12.21 -0.3 18.65 4.82 22.62 5.5 23.03 6.02 23.28 6.65 23.03 6.96 22.8 9.43 21.13 12.8 16.69 11.71 10.41" fill="#10AA50"></path>
      <path d="M5.95 19.5C5.82 21.08 5.72 22 5.38 22.9 5.38 22.9 5.61 24.41 5.76 26L6.32 26C6.45 24.88 6.65 23.76 6.92 22.66 6.21 22.33 5.98 20.89 5.95 19.5Z" fill="#B8C4C2"></path>
...
const Github = (props: any) => <svg className={props.className + " octicon octicon-mark-github v-align-middle"} height={props.height ?? "32"} viewBox="0 0 16 16" version="1.1" width={props.width ?? "32"} aria-hidden="true">
